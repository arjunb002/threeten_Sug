...
img = Image.open('/mount/src/threeten_sug/logo.png')
img_logo = Image.open('/mount/src/threeten_sug/10_wo_white_bg_1.png')
...
with open("/mount/src/threeten_sug/stock_list_500.py", "rb") as file:
