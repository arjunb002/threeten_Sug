...
img = Image.open('arjunb002/threeten_sug/main/logo.png')
img_logo = Image.open('arjunb002/threeten_sug/main/10_wo_white_bg_1.png')
...
with open("arjunb002/threeten_sug/main/stock_list_500.py", "rb") as file:
